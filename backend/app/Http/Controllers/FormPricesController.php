    ...
    public function store(Request $request): JsonResponse
    {
        try {
            $validatedData = $request->validate([
                ...
                'prix_eur_hebergement' => 'integer|min:0',
                'prix_article_tun' => 'integer|min:0',
                'prix_article_eur' => 'integer|min:0',
                'prix_acc_adulte_tun' => 'integer|min:0',
                'prix_acc_adulte_eur' => 'integer|min:0',
                'prix_acc_enfant_tun' => 'integer|min:0',
                'prix_acc_enfant_eur' => 'integer|min:0',
                'prix_nuit_supp_tun' => 'integer|min:0',
                'prix_nuit_supp_eur' => 'integer|min:0',
                'prix_single_supp_tun' => 'integer|min:0',
                'prix_single_supp_eur' => 'integer|min:0',
            ]);
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        try {
            ...
            $validatedData = $request->validate([
                ...
                'prix_eur_hebergement' => 'sometimes|integer|min:0',
                'prix_article_tun' => 'sometimes|integer|min:0',
                'prix_article_eur' => 'sometimes|integer|min:0',
                'prix_acc_adulte_tun' => 'sometimes|integer|min:0',
                'prix_acc_adulte_eur' => 'sometimes|integer|min:0',
                'prix_acc_enfant_tun' => 'sometimes|integer|min:0',
                'prix_acc_enfant_eur' => 'sometimes|integer|min:0',
                'prix_nuit_supp_tun' => 'sometimes|integer|min:0',
                'prix_nuit_supp_eur' => 'sometimes|integer|min:0',
                'prix_single_supp_tun' => 'sometimes|integer|min:0',
                'prix_single_supp_eur' => 'sometimes|integer|min:0',
            ]);
