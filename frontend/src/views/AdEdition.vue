    ...
    <div v-if="showUpdateModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 transition-opacity duration-300">
      <div class="bg-white p-6 rounded-lg w-full max-w-md shadow-md font-poppins max-h-[90vh] overflow-y-auto">
        ...
        <div class="space-y-4">
          ...
          <div>
            <label for="description_fr" class="block text-sm font-medium text-gray-700">French Description</label>
            <textarea
          ...
          <div>
            <label for="description_en" class="block text-sm font-medium text-gray-700">English Description</label>
            <textarea
          ...
          <div>
            <label for="dossier_sponso" class="block text-sm font-medium text-gray-700">Sponsorship File</label>
            <input
              type="file"
              id="dossier_sponso"
...
.conference-card {
  ...
  max-width: 1000px; /* Limit width to fit within layout */
