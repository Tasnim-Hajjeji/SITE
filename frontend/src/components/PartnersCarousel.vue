...
const logos = [
    '/assets/logos/iset.png',
    '/assets/logos/pole.png',
    '/assets/logos/lmpe.png',
    '/assets/logos/isier.png',
    '/assets/logos/esim.png',
    '/assets/logos/enib.png',
    '/assets/logos/fst.png',
    '/assets/logos/ensit.png',
    '/assets/logos/tds.png'
]
