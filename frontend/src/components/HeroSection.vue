<template>
    <section class="hero">
      <div class="content">
        ...
        <div class="image-container">
          <img src="../assets/heart.jpeg" alt="Heart Image" class="hero-image" />
        </div>
  ...
  .image-container {
    max-width: 30%;
    margin-top: -10rem; /* Ajusté pour coller à la navbar */
    margin-right: 2rem; /* Ajusté pour coller à la navbar */
